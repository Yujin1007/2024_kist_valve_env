...
public:
    ...
    void read_pybind(double t, std::array<double,9> q, std::array<double, 9> qdot, double timestep,std::array<double, 66> pos, double q_valve, double qdot_valve);
    ...
    void put_action2_pybind(array<double, 2> action_rotation, double action_force);
    ...
    tuple<array<double,6>,array<double,6>> get_hand_pybind();
    ...
    double get_force_pybind();

tuple<double,double> get_rollpitch_pybind();
    ...
    // array<double,6> x_hand, xdot_hand;
    vector<double> x_hand, xdot_hand;
...
private:
    ...
    double _force_gain,force_gain, _dforce_gain;
