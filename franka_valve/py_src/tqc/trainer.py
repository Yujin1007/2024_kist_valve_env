...
class Trainer(object):
	def __init__(
		...
		*,
		...
		if demo_path is not None:
			self.replay_buffer_expert = self.load_replay_buffer(demo_path)
			self.isdemo = True
		else:
			self.isdemo = False
	...
	def train(self, replay_buffer, batch_size=256):
		if self.isdemo:
			...
			sample_demo = self.replay_buffer_expert.sample(int(batch_size / 2))
	...
	def save_replay_buffer(self,buffer, filename):
